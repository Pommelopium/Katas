# Kata 05_16 — Stadt Land Fluss

**Architecture Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/architecture-katas/stadt-land-fluss/)

## Ziel

Ein Programm entwerfen, mit dem mehrere Spieler gemeinsam Stadt-Land-Fluss spielen koennen, wenn sie zusammensitzen.

## Anforderungen

- Eindeutige Spiel-ID generieren, optional Email-Einladungen versenden
- Kategorien, Timeout und Rundenzahl konfigurieren
- Zufaelligen Buchstaben anzeigen, Spieler geben ihre Loesungen ein
- Punktesystem: solo 20, eindeutig 10, doppelt 5, keine Loesung 0
- Manuelle Punktevergabe durch die Spieler, automatische Gesamtpunktberechnung
- Spielende nach der konfigurierten Rundenzahl oder vorzeitig

## Variationen und Randbedingungen

- Randbedingungen: manuelle Punktevergabe ist noetig, weil die Korrektheit spielerabhaengig ist; Fairness wird vorausgesetzt
- Automatisierte Bewertung durch alle Spieler mit Konfliktloesung durch den Initiator
