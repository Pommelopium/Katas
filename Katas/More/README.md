...
**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/application-katas/more/)

## Ziel

Eine Konsolenanwendung entwickeln, die Textdateien seitenweise anzeigt (20 Zeilen pro Seite) und auf Benutzereingaben wartet.

## Anforderungen

- Aufruf: `more <dateiname>`
- Erste Seite mit 20 Zeilen anzeigen
- Nach jeder Seite auf einen Tastendruck warten
- Mit [Esc] abbrechen, mit jeder anderen Taste weiterblaettern
- Hinweismeldung: `Weiter mit jeder Taste. Abbruch mit [Esc].`

## Beispiele und Testfaelle

- Grosse Dateien duerfen den Speicher nicht fuellen -- `IEnumerable<string>` bzw. `File.ReadLines` statt `ReadAllLines`

## Variationen und Randbedingungen

- Optionale Seitenlaenge als Parameter, z. B. `more advent.txt 15`
- Seitennummer und Gesamtzeilenzahl vor dem Seiteninhalt anzeigen
