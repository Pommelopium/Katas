# Kata 04_21 — Taschenrechner

**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/application-katas/taschenrechner/)

## Ziel

Einen Taschenrechner mit grafischer Oberflaeche entwickeln, bei dem Eingaben nur ueber Schaltflaechen moeglich sind und Operationen sequenziell mit gleicher Prioritaet verarbeitet werden.

## Anforderungen

- Zahleneingabe ausschliesslich ueber Ziffernschaltflaechen
- Operationen +, -, *, /, = mit einheitlicher Praezedenz
- Division durch Null: Meldung anzeigen, bisheriges Ergebnis erhalten
- Anzeige nach jeder Eingabe aktualisieren

## Beispiele und Testfaelle

- `2` `0` `+` `3` `*` `4` `=` ergibt 92, weil alle Operatoren gleich priorisiert sind
- `8` `/` `0` -> Fehlermeldung, Ergebnis bleibt 8

## Variationen und Randbedingungen

- Loeschen- und Zuruecksetzen-Funktion ergaenzen
- Potenzoperation `^` einfuehren
- Operatoren nach Prioritaet ordnen: `^` vor `*` und `/` vor `+` und `-`
