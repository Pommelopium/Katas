# Kata 05_05 — Heckle Service

**Architecture Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/architecture-katas/heckle-service/)

## Ziel

Ein System entwerfen, mit dem Konferenzteilnehmer Zwischenrufe (Fragen, Feedback) an Referenten senden, die diese in Echtzeit per Benachrichtigung erhalten.

## Anforderungen

- Webbasierte Eingabemaske fuer Zwischenrufe (max. 512 Zeichen), optional Betreff (max. 50 Zeichen), Name und Email
- Push-Benachrichtigungen an das registrierte Smartphone des Referenten
- Webseite zur Detailanzeige einzelner Zwischenrufe
- Uebersichtsseite fuer alle eingegangenen Zwischenrufe
- Registrierungsprozess fuer Vortraege mit Zeitfenster fuer die Annahme von Zwischenrufen
- Vortragsliste bzw. Kuerzel-Eingabe zur Vortragsauswahl
- Email-Export und Online-Loeschung nach dem Vortrag

## Beispiele und Testfaelle

- Externe Dienste wie Pushover koennen fuer Benachrichtigungen genutzt werden; eine eigene Mobile-App ist nicht zwingend

## Variationen und Randbedingungen

- Teilnehmer koennen ihre eigenen Zwischenrufe vortragsuebergreifend einsehen, identifiziert ueber die Email-Adresse
