# Kata 04_20 — Stimmungsbarometer

**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/application-katas/stimmungsbarometer/)

## Ziel

Eine Anwendung entwickeln, mit der verteilte Gruppen ihre aktuelle Stimmung messen und den Verlauf ueber mehrere Runden nachverfolgen koennen.

## Anforderungen

- Stimmungsskala von -n bis +n (Standard 1), pro Gruppe konfigurierbar
- Jedes Mitglied gibt pro Runde hoechstens einmal seine Stimmung ab; die Runde endet, wenn alle abgestimmt haben
- Nur aggregierte Werte anzeigen (Min, Max, Durchschnitt) -- keine Zuordnung zu Personen
- Authentifizierung per Email-Adresse gegen Doppelabstimmungen
- Start und Abschluss von Runden kommunizieren
- Gespeicherte Werte enthalten nur Hashes statt Email-Adressen
- Der Stimmungsverlauf ist jederzeit fuer alle einsehbar
- Gruppe einrichten mit Name, Parametern und Mitgliederliste

## Beispiele und Testfaelle

- Anonymitaet trotz Doppelabstimmungsschutz ist der interessante Entwurfskonflikt dieser Kata

## Variationen und Randbedingungen

- Automatisierte Aufforderungen in konfigurierbarer Frequenz (stuendlich, taeglich)
