# Kata 05_01 — Aktives Kochbuch

**Architecture Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/architecture-katas/aktives-kochbuch/)

## Ziel

Eine Webanwendung entwerfen, die Nutzern personalisierte Kochvorschlaege aus ihrer eigenen Rezeptsammlung macht.

## Anforderungen

- Nutzer legt ein persoenliches Kochbuch mit Rezepten an (Titel, Rezeptur, Tags)
- Das System schlaegt Rezepte vor; Anzahl und Tag-Filter sind waehlbar
- Einzelne Vorschlaege lassen sich interaktiv anfordern
- Automatische, regelmaessige Vorschlaege nach eingestelltem Rhythmus
- Zeitplanung konfigurierbar nach Wochentagen und Uhrzeiten, z. B. jeden Freitag und Samstag
- Vorschlaege per Email mit Titel, Bild und Rezept-Link
