# Kata 04_12 — LOC Count

**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/application-katas/loc-count/)

## Ziel

Ein Programm entwickeln, das die Lines of Code aller C#-Dateien in einem Verzeichnisbaum analysiert und auswertet. Baut auf der Function Kata LOC auf.

## Anforderungen

- Verzeichnisbaum rekursiv nach C#-Quelldateien durchsuchen
- LOC pro Datei berechnen und dabei die Funktion aus der LOC-Kata wiederverwenden
- Pro Datei ausgeben: vollstaendiger Pfad, LOC-Anzahl, Gesamtzeilenzahl
- Zusammenfassung: Summe aller Zeilen und aller LOC
- Kommandozeilen-Interface mit dem Verzeichnis als Parameter

## Beispiele und Testfaelle

```
loccount.exe d:\myproject
-> Dateiname;LOC;Zeilen je Datei
-> Total: Lines und LOC summiert
```
