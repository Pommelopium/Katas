# Kata 04_03 — Comparative Estimation

**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://paper.dropbox.com/doc/Application-Kata-Comparative-Estimation-m84pq6UJXv1ecqUSSzOBu)

## Ziel

Aufgabenstellung liegt auf Dropbox Paper und ist nicht automatisiert abrufbar.

## Hinweis

Diese Kata liegt nicht auf ccd-school.de, sondern auf einer externen Plattform und laesst
sich nicht automatisiert auslesen. Oeffne den Link oben und uebertrage die Aufgabenstellung
hierher, bevor du startest.
