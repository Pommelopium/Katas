# Kata 03_01 — Benutzeranmeldung

**Library Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/library-katas/benutzeranmeldung/)

## Ziel

Eine Bibliothek entwickeln, die Registrierung, Anmeldung und Verwaltung von Websitenutzern uebernimmt, mit tokenbasierten Sessions.

## Anforderungen

- Registrierung mit Email, Passwort und Nickname; Passwort generieren, falls nicht angegeben
- Bestaetigungsemail mit Link und Registrierungsnummer versenden
- Unbestaetigte Registrierungen verfallen nach einer Frist
- Anmeldung mit Email oder Nickname plus Passwort, Rueckgabe eines unfaelschbaren Tokens
- Funktion zur Token-Validierung
- Passwort-Reset-Prozess per Email
- Daten aendern (Email, Nickname, Passwort) und Benutzer loeschen, jeweils tokenbasiert autorisiert
- Passwoerter niemals im Klartext speichern
- Konfigurierbar: Datenbank, SMTP, URLs

## Beispiele und Testfaelle

- Die Kata-Seite gibt die Schnittstellen als Code-Interfaces vor -- diese zuerst uebernehmen und dann gegen sie testen
