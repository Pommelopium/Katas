# Kata 05_19 — Tomatentimer

**Architecture Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/architecture-katas/tomatentimer/)

## Ziel

Eine Anwendung entwerfen, mit der Teamkollegen nach der Pomodoro-Technik arbeiten und ihre Aufgaben und Fortschritte verfolgen.

## Anforderungen

- Anmeldung mit Nickname und Email-Adresse
- Tomaten zu 25 Minuten starten, Zeit anzeigen, akustischer und optischer Alarm bei Ablauf
- Jeder Tomate eine aktuelle Aufgabe zuweisen; die vorherige Aufgabe als Vorschlag fuer die naechste
- Automatisch 5 Minuten Pause nach jeder Tomate, jede dritte Pause 15 Minuten, Pausen unterbrechbar
- Uebersicht 1: Statistik absolvierter und abgebrochener Tomaten mit Themen
- Uebersicht 2: alle Benutzer mit Status und verbleibender Zeit
- Anfrage per Email an andere Benutzer, sich in der naechsten Pause zu melden

## Beispiele und Testfaelle

- Vergleiche den Zuschnitt mit der Application Kata MobTimer: aehnliche Fachlichkeit, aber hier verteilt und mehrbenutzerfaehig

## Variationen und Randbedingungen

- Timer-Dauern konfigurierbar
- Team- und Benutzerverwaltung fuer mehrere Teams oder Unternehmen
- Akkumulierte Zeit pro Thema tracken
