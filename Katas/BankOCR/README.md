...
**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/application-katas/bankocr/)

## Ziel

Ein Programm schreiben, das Kontonummern aus ASCII-Dateien erkennt, in denen Ziffern als Zeichenmuster kodiert sind.

## Anforderungen

- Eingabe: Textdatei mit Ziffernfolgen, die ueber drei Zeilen kodiert sind
- Jede Ziffer ist 3 Zeichen breit und 3 Zeilen hoch
- Leerzeichen trennen Ziffern, Leerzeilen trennen Ziffernfolgen
- Ziffern bestehen aus `_` und `|`
- Ausgabe: die erkannten Ziffernfolgen zeilenweise
- Aufruf: `bankocr datei1.txt`
...
- Fehlerhafte Zeilen mit `Fehlerhafte Zeile` kennzeichnen
