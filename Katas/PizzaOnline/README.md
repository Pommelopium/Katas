# Kata 05_12 — Pizza Online

**Architecture Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/architecture-katas/pizza-online/)

## Ziel

Eine Webanwendung fuer Online-Pizzabestellungen entwerfen: der Kunde stellt seine Bestellung zusammen und bestaetigt sie, beim Pizzadienst wird sie automatisch ausgedruckt.

## Anforderungen

- Speisekarte aus einer CSV-Datei laden und mit Bildern anzeigen
- Kunde waehlt Pizzen mit Mengen und Groessen
- Persoenliche Daten erfassen: Name, Adresse, Telefon, Email
- Zusammenfassung mit Bestellnummer vor der finalen Bestaetigung
- Korrekturmoeglichkeit mit vorausgefuellten Daten
- Nach Bestaetigung: automatischer Ausdruck und Archivierung als XML oder JSON
- Quittungsemail an den Kunden
- Persoenliche Daten fuer zukuenftige Bestellungen im Cookie speichern

## Beispiele und Testfaelle

- Die Bestellung wird beim Bringdienst nur ausgedruckt -- es gibt dort kein weiteres System
- Bilder liegen im selben Verzeichnis wie die CSV-Datei
