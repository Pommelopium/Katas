# Kata 05_14 — Sammelbestellung

**Architecture Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/architecture-katas/sammelbestellung/)

## Ziel

Eine Webanwendung entwerfen, ueber die sich Interessenten zu Sammelbestellungen zusammenfinden; die Bestellung wird beim Erreichen einer Mengen- oder Zeitgrenze automatisch ausgeloest.

## Anforderungen

- Angebote mit Ablaufdatum und/oder Bestellmengenschwelle verwalten
- Automatische Bestellung beim Erreichen der Schwellmenge oder des Datums, sofern die Mindestmenge erfuellt ist
- Interessenten koennen sich ein- und austragen; verbleibende Zeit und Menge werden angezeigt
- Email-Benachrichtigung an alle Interessenten bei Bestellabschluss, positiv wie negativ
- Der Anbieter erhaelt eine CSV mit den Kundendaten
- Benutzerverwaltung mit Anmeldung; jeder Benutzer kann Anbieter und Interessent zugleich sein

## Variationen und Randbedingungen

- Angebote koennen neu aufgelegt werden, mit stabiler URL und versionierten Links
- Registrierung fuer Benachrichtigungen bei Neuauflagen
