# Kata 04_04 — Convert Roman

**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/application-katas/convert-roman/)

## Ziel

Eine Konsolenanwendung erstellen, die roemische Zahlen in arabische umwandelt und umgekehrt.

## Anforderungen

- Eingabe als Kommandozeilenparameter, roemisch oder arabisch
- Ausgabe auf Standard Output
- Roemische Zahlen im Bereich I bis MMM unterstuetzen
- Automatisch erkennen, in welche Richtung konvertiert werden muss

## Beispiele und Testfaelle

- `convertroman XLII` -> `42`
- `convertroman MMXV` -> `2015`

## Variationen und Randbedingungen

- Textdateien verarbeiten ueber das Flag `-f=dateiname.txt`
