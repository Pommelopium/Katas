# Kata 04_22 — Textumbruch (Application)

**Application Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/application-katas/textumbruch/)

## Ziel

Eine Anwendung entwickeln, die Text und Spaltenbreite vom Benutzer entgegennimmt und den umgebrochenen Text ausgibt. Baut auf der Function Kata Textumbruch auf.

## Anforderungen

- Textbox fuer den Eingabetext
- Eingabefeld fuer die gewuenschte Spaltenbreite
- Schaltflaeche, die den Umbruch ausloest
- Textbox zur Anzeige des Ergebnisses

## Beispiele und Testfaelle

- `Vor einem grossen Walde wohnte ein armer Holzhacker mit seiner Frau...` bei Breite 25

## Variationen und Randbedingungen

- Kommandozeilenvariante mit Parametern fuer Dateiname und Breite
- Silbentrennung ueber die Bibliothek NHunspell
