# Kata 05_08 — Kantinenstaumelder

**Architecture Kata** aus dem [CCD Coding Dojo](https://ccd-school.de/coding-dojo/) | [Original-Aufgabenstellung](https://ccd-school.de/coding-dojo/architecture-katas/kantinenstaumelder/)

## Ziel

Eine Webanwendung entwerfen, die Mitarbeitern in Echtzeit zeigt, wie ausgelastet die Kantine gerade ist.

## Anforderungen

- Abfertigungsfluss als Kurve visualisieren: Zeit auf der X-Achse, Messwert auf der Y-Achse
- Farbliche Zonierung (gruen, gelb, rot) zur Auslastungsanzeige
- Zugriff ueber den Browser
- Messgroesse: Durchsatz an den Kantinenkassen oder freiwillige Signale von Mitarbeitern
- Smartphone-Benachrichtigung bei Unterschreitung eines eingestellten Schwellwerts

## Variationen und Randbedingungen

- Randbedingungen: die Messung soll einfach umsetzbar sein; Muster werden durch Urlaubszeit, Trainings oder Besucher durchbrochen; automatische Messung an den Kassen ist manuellen Signalen vorzuziehen
